...
// Setup Product & ProductInterest associations
Product.hasMany(ProductInterest, {
  foreignKey: 'productId',
  as: 'interests',
  onDelete: 'CASCADE',
});
ProductInterest.belongsTo(Product, {
  foreignKey: 'productId',
  as: 'product',
});

// Setup User & ProductInterest associations
User.hasMany(ProductInterest, {
  foreignKey: 'userId',
  as: 'interests',
  onDelete: 'SET NULL',
});
ProductInterest.belongsTo(User, {
  foreignKey: 'userId',
  as: 'user',
});
