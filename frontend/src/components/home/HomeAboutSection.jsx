      ...
      >
        ...
        >
          ...
          <div className="about-visual-col" style={{ position: 'relative' }}>
            ...
            >
              <div
                className="about-badge-icon-box"
                style={{
                  width: '34px',
                  height: '34px',
                  borderRadius: '10px',
            ...
            >
              ...
              >
                <Heart size={18} fill="#F472B6" className="about-badge-icon" />
              </div>
              <div>
          ...
          <div className="about-narrative-col" style={{ display: 'flex', flexDirection: 'column' }}>
            {/* Badge Tag */}
            <div
              className="about-tag"
              style={{
            ...
            {/* Action Buttons */}
            <div className="about-actions-row" style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
              <Link
                href="/about"
                style={{
                  display: 'inline-flex',
